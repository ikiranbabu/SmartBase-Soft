...
import { SmartsoftTestModule } from '../../../test.module';
import { SmartsoftHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { SmartsoftHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('SmartsoftHealthCheckComponent', () => {

        let comp: SmartsoftHealthCheckComponent;
        let fixture: ComponentFixture<SmartsoftHealthCheckComponent>;
        let service: SmartsoftHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [SmartsoftTestModule],
                declarations: [SmartsoftHealthCheckComponent],
                providers: [
            ...
            }).overrideTemplate(SmartsoftHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(SmartsoftHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(SmartsoftHealthService);
        });
